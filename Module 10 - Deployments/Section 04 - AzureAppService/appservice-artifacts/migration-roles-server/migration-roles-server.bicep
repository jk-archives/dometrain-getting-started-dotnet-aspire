...
param server_outputs_name string

param server_outputs_sqlserveradminname string
...
resource script_server_podcasts 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('server', principalName, 'podcasts', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
