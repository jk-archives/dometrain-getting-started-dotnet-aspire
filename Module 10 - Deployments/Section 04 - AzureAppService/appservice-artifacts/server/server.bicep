...
resource sqlServerAdminManagedIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2024-11-30' = {
  name: take('server-admin-${uniqueString(resourceGroup().id)}', 63)
  location: location
}
...
resource podcasts 'Microsoft.Sql/servers/databases@2023-08-01' = {
  name: 'podcasts'
  location: location
  properties: {
...
output sqlServerAdminName string = server.properties.administrators.login